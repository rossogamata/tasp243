...
До наступного заняття курсант має вміти усно пояснити цю архітектуру та намалювати її від руки без команд і консолі. Практична схема буде оформлена окремо на практичному занятті 1.4.
