...
|---|---|---|---|
| 1.1 | Лекція | Пояснює теорію та фінальну архітектуру | Слухає, ставить питання, фіксує модель |
| 1.2 | Групове | Демонструє команди побудови VPC | Спостерігає та аналізує результат команд |
| 1.3 | Практика | Консультує та перевіряє контрольні точки | Самостійно проєктує й створює мережу |
| 1.4 | Лекція | Пояснює EC2, ALB, S3, CloudFront і Lambda | Готує питання та архітектурні рішення |
...
### 1.2. Групове: мережева демонстрація
...
### 1.4. Лекція: сервіси побудови рішення

Матеріал: [Lesson1_4](Lesson1_4/README.md)

Курсант вивчає EC2, ALB, S3, CloudFront і Lambda, їхні межі застосування та місце у фінальній архітектурі. Команд AWS на лекції немає.

**Результат:** оновлена ментальна та архітектурна модель продукту.

### 1.5. Групове: демонстрація розгортання

Матеріал: [Lesson1_5](Lesson1_5/README.md)

Викладач показує запуск EC2, target group, ALB, S3 і Lambda на основі VPC з Lesson1_3. Команди мають коментарі, що пояснюють параметри та очікуваний результат.
...
| 1.2 | Розуміння алгоритму та команд VPC |
| 1.3 | Реальна VPC, subnet, маршрути та правила |
| 1.4 | Архітектура обчислень, сховища і доставки |
