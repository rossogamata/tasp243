...
## Модуль 2. Технології контейнеризації

### 2.3. Практика: перший персональний контейнер

Матеріал: [Lesson2_3](Lesson2_3/README.md)

Курсант вручну персоналізує сайт, створює Docker image з `Dockerfile`, запускає NGINX-контейнер, перевіряє його через браузер і публікує образ у власному Docker Hub repository. Для швидкої перевірки результату використовується оригінальний морський мультяшний стиль та SVG-банер архітектури.

**Результат:** власний образ і контейнер із сайтом, де викладач бачить прізвище курсанта.
